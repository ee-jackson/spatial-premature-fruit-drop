...
The ZIB models are predicting a much lower proportion of zeros than are found in the data, whereas the ZOIB's look bang-on. Not sure why the ZIBs look so bad...
...
Pareto k estimates give an indication of how ‘influential’ each point is. The higher the value of 
k, the more influential the point. Values of k over 0.7 are not good - indicates potential model misspecification.
...
Do the binomial models look weird because of the observation-level random effects I added to account for overdispersion? Why are there 2 bands?
...
Quite different! I think we expect that they will be pulled toward the group mean, but how much is too much? [This](https://towardsdatascience.com/when-mixed-effects-hierarchical-models-fail-pooling-and-uncertainty-77e667823ae8) is useful.

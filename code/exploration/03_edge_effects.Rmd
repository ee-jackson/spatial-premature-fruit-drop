...
Correcting for edge effects using this method gives a lower median error than using the observed value. The radii giving the lowest median errors are between 100 - 140 m (the difference in error between these is negligible).

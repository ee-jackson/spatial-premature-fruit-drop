...
![species_slope_estimates](figures/08_final-model-results/sp_ests.png)
...
![fitted_draws](figures/08_final-model-results/epred_draws.png)
...
![parameter_estimates](figures/08_final-model-results/post_params.png)
